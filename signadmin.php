<?php
    if($_SERVER['REQUEST_METHOD']=='POST')
    {
        ...
        $sql="select * from record where stname='$username'and password='$password'";
        ...
        if($result)
        {
            ...
            {
                $sql="insert into record(stid,stname,password) values('$userid','$username','$password')";
                $result=mysqli_query($c,$sql);
...
.content{
  ...
  <div class="navbar">
    ...
    <h1 class="text-info text-center p-3">STUDENT REGISTRATION PORTAL</h1>
    <div class="bg-info">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control w-50 m-auto" name="userid" id="userid" placeholder="Enter  id" require="required">
